package com.ian.novelia.novel.dto.response;
...
@AllArgsConstructor
@Builder
@Schema(description = "소설 목록 조회 요청 응답")
public class GetNovelResponseDto {
    ...
    public static GetNovelResponseDto from(Novel novel) {
        return GetNovelResponseDto.builder()
                .id(novel.getId())
